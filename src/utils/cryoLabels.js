...
export const LWCS = {
  ...
  '506': { label: '0.5 mL Eppendorf', tube: 'eppi', cap: true, W: 33.4, H: 12.7, wrapW: 23.9, circ: 9.5, qr: 6.5, ecc: 'L', qrSize: 'VerySmall', fName: 2.6, fCas: 1.6, fCode: 2.6, fMin: 1.7, useShort: true, rule: false, labelName: 'LWCS506', rect: { x: 0.012187534, y: 0.0075000003, w: 1.2833055, h: 0.43402776 } },
  '507': { label: '1.5 mL Eppendorf', tube: 'eppi', cap: true, W: 39.7, H: 15.9, wrapW: 28.6, circ: 11.1, qr: 7.6, ecc: 'L', qrSize: 'Small', fName: 2.7, fCas: 1.8, fCode: 2.7, fMin: 1.6, rule: true, labelName: 'LWCS507', rect: { x: 0.012187534, y: 0.045138888, w: 1.5, h: 0.5509028 } },
