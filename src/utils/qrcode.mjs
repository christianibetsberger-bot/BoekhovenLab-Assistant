// Vendored from npm package `qrcode-generator` v2.0.4 (dist/qrcode.mjs)
// https://github.com/kazuhikoarase/qrcode-generator — MIT license (header below).
// Vendored verbatim because this project has no local Node toolchain to
// manage package-lock updates; do not hand-edit.
//---------------------------------------------------------------------
//
